...
public class DefaultDelltrainingcommercewebservicesService implements DelltrainingcommercewebservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultDelltrainingcommercewebservicesService.class);
	...
	{
		return DefaultDelltrainingcommercewebservicesService.class.getResourceAsStream("/delltrainingcommercewebservices/sap-hybris-platform.png");
	}

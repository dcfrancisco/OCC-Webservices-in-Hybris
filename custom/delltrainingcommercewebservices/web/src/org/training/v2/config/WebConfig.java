...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "delltrainingcommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "delltrainingcommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "delltrainingcommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "delltrainingcommercewebservices.v2.description";
	private static final String TITLE = "delltrainingcommercewebservices.v2.title";
	private static final String VERSION = "delltrainingcommercewebservices.v2.version";
	private static final String LICENSE = "delltrainingcommercewebservices.v2.license";
	private static final String LICENSE_URL = "delltrainingcommercewebservices.v2.license.url";
